...
Что сделано:по возрастанию рейтинга; по убыванию рейтинга; без сортировки (выполнено через рэндом, с связи с отсутствием допю требований к заданию)

1. Добавлена панель для сортировки стремя кнопками
2. добавлены 3 кнопки: 
