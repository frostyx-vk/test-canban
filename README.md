...
1. Добавлена панель для сортировки с тремя кнопками
2. Добавлены 3 кнопки: по возрастанию рейтинга; по убыванию рейтинга; без сортировки (выполнено через рэндом, в связи с отсутствием доп. требований к заданию);
